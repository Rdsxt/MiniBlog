...
const Register = () => {
  ...
  return (
    <div className={styles.register}>
        ...
        <p>Crie sua conta agora e comece a contar sua história</p>
        <form onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <input type="password" name="confirmPassword" required placeholder="Confime sua senha" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
          </label>
